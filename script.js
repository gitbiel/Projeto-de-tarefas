  ...
  cardsLocalStorage?.map((card)=> {
    ...
    const newCard =`
     ...
     <div id="BorderCorOption" style="background:${typeColor[1]}"> 
                <div onclick="marcarTarefa(${card.id})">
                      <i id="icone_${card.id}" class="mdi mdi-circle-outline"></i>
                <div/>
                 <div>
                 ...
                 <div>
                      <svg  class="removeCard" onclick ="deleteCard(${card.id})" width="17" height="17" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
